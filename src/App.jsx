  ...
  return (
    <>
      <div className="game-list">
        <Game name="Ninja Dodge" image={logo1} winCondition="Hoàn thành 2 màn" link="https://haiphan2309.itch.io/ninja-dodge"/>
        <Game name="Falling Shapes" image={logo2} winCondition="Đạt 1000 điểm" link="https://haiphan2309.itch.io/falling-shapes"/>
        <Game name="Hexalink" image={logo3} winCondition="Hoàn thành 4 màn hoặc 30k điểm" link="https://gedusx.itch.io/hexalink"/>
        <Game name="Mazexpand" image={logo4} winCondition="Hoàn thành 5 màn" link="https://beastkr.itch.io/mazexpand/"/>
        <Game name="Shooting Gallery" image={logo5} winCondition="Đạt 3000 điểm" link="https://gloxiniaaa.github.io/UnityWebGL_Shooting-Gallery/"/>
